...
var _stringProperties = {};
  ...
  function createAudioCtx () {  // > CustomCode.Audio Ctx Functions:73
    ...
    processor.onaudioprocess = function(e) {  // > CustomCode.Audio Ctx Functions:103
      ...
      for (i=0; i<dataArray.length; i++) {  // > CustomCode.Audio Ctx Functions:122
        ...
        freqArray[i] = i * baseFreq/2000.0;  //in Hz  // > CustomCode.Audio Ctx Functions:124
  ...
  adjustFreqCursors();
          ...
          _view.Df.linkProperty("Text",  function() { return "\u0394f="+(freqEnd-freqStart).toFixed(2)+" Hz"; } ); // HtmlView Page linking property 'Text' for element 'Df'
  ...
  peakThreshold=Math.min(peakThreshold, -20);
          ...
          _view.minFreqLabel.linkProperty("Text",  function() { return mobileDisplay?"Hz: min":"    Frequency (Hz): min"; } ); // HtmlView Page linking property 'Text' for element 'minFreqLabel'
